    ...
    axios
      ...
      .then(res => {
        ...
        this.setState({
          ...
          organizerEvents: res.data.organizer_events,
          attendeeEvents: res.data.attendee_events
        });
  ...
  render() {
    ...
    const updateForm = (
      <Form onSubmit={this.submitUpdate}>
        ...
        <Form.Field>
          <button type="submit" value="Update Profile" inverted>
            Submit
          </button>
        </Form.Field>
      </Form>
                ...
                <Card.Group>
                  <Card>
                    <Card.Content>
                      ...
                      <Link to="">
                        {" "}
                        <Card.Header>{orgEvent.title}</Card.Header>
                      </Link>
                      ...
                      <Card.Content extra>
                        <div className="ui two buttons">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              this.deleteEvent(
                                this.state.organizerEvents[index].id
                              )
                            }
                          >
                            Cancel Event
    ...
    const attendeeEvents = this.state.attendeeEvents.map(
      (attenEvent, index) => {
            ...
            <Card.Group>
              <Card>
                <Card.Content>
                  ...
                  <Link to="">
                    {" "}
                    <Card.Header>{attenEvent.title}</Card.Header>
                  </Link>
            ...
            <div class="clouds">
              <div>
                <Profile>
                    ...
                    <List.Item>
                      ...
                      <List.Item>
                        <Number>
                          ...
                          <List.Content>{this.state.user.number}</List.Content>
                        </Number>
                      </List.Item>
                    </List.Item>
                  </List>
                  ...
                  <button
                    onClick={() =>
                      this.deleteUser(this.props.match.params.userId)
                    }
                  >
                    Delete Profile
                  </button>
                ...
                <center>
                  <OrgEvents>
                    <h1>Events You Are Organizing</h1>
                    <hr />
                    <Link to={`/users/${userId}/events/new`}>
